	...
	private function get_css_config() {
		...
		return array(
			...
			'.tb-button__link' => array(
				parent::KEY_STYLES_FOR_COMMON_STYLES => array_merge( $styling_styles, array( 'font-size', 'line-height' ) ),
			),
			'.tb-button__link:hover' => array(
				parent::KEY_STYLES_FOR_HOVER => array_merge( $styling_styles, array( 'font-size', 'line-height' ) ),
			),
			...
			'.tb-button__link:hover .tb-button__content' => array(
				parent::KEY_STYLES_FOR_HOVER => $fonts_styles,
			),
			'.tb-button__link:active .tb-button__content' => array(
