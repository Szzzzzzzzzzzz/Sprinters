...
class WPDD_Layouts {
	...
	public function init_gutenberg_overlay(){
		...
		$gutenberg_overlay = new WPDD_Layouts_Gutenberg_Overlay( 'layouts', 'div.editor-block-list__block, div.block-editor-block-list__block', $gutenberg_condition, $request_mode, $post_id );
