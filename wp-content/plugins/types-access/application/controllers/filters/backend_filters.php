...
class BackendFilters {
	...
	public static function admin_enqueue_scripts() {
		...
		if (
			...
			if (
				( defined( 'TACCESS_DEBUG' ) && TACCESS_DEBUG )
				|| ( defined( 'SCRIPT_DEBUG' ) && SCRIPT_DEBUG )
			) {
				TAccess_Loader::loadAsset( 'SCRIPT/wpcf-access-sticky-headers', 'wpcf-access-sticky-headers-src' );
			} else {
				TAccess_Loader::loadAsset( 'SCRIPT/wpcf-access-sticky-headers', 'wpcf-access-sticky-headers' );
			}
