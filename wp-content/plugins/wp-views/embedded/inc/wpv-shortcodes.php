...
function wpv_login_form( $args = array() ) {
	...
	*/
	...
	$form = '
		<form name="' . $args['form_id'] . '" id="' . $args['form_id'] . '" action="' . esc_url( $action_url ) . '" method="post">
			' . $login_form_top . '
...
function wpv_forgot_password_form( $args = array() ) {
	...
	$form = '
		<form name="' . esc_attr( $args['form_id'] ) . '" id="' . esc_attr( $args['form_id'] ) . '" action="' . esc_url( $lost_password_url ) . '" method="post">
			' . $form_top . '
			<p class="login-username">
				<label for="' . esc_attr( $args['id_username'] ) . '">' . esc_html( $args['label_username'] ) . '</label>
...
function wpv_reset_password_form( $args = array() ) {
	...
	$form = '
		<form name="' . esc_attr( $args['form_id'] ) . '" id="' . esc_attr( $args['form_id'] ) . '" action="' . esc_url( $action_url ) . '" method="post">
			' . $form_top . '
			<p class="reset-pass">
