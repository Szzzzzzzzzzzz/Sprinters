...
$cfg['blowfish_secret']					= '~QGuc>OIL,/MO0.H=NP(~uc_c4DK+SvO' ;  // i.e. '$b~`lnkwm>^^jNUEE;(4xB$L\'b?."\'o9' 
...
$cfg['PmaAbsoluteUri'] 					= '/wp-content/plugins/wp-phpmyadmin-extension/lib/phpMyAdmin_mqMIiN9REjysnvUFKzLTD0W/';			//used, if different directory by htaccess ; or parse_url($GLOBALS['PMA_PHP_SELF']);
